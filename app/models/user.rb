class User < ActiveRecord::Base
  ...
  def admin?
    %w(account@parti.xyz rest515@parti.xyz youloverosa@gmail.com dalikim@parti.xyz lulu@parti.xyz qus1225@gmail.com muni@parti.xyz foroso@gmail.com notforsale0@gmail.com).include? email
  end
end
